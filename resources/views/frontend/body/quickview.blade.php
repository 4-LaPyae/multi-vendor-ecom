                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            <h5 class="title-detail">
                                <a href="shop-product-right.html" class="text-heading" id="pname">
                                </a>
                            </h5>
                            <br>
                            ...
                            <div class="clearfix product-price-cover">
                                <div class="">
                                    <h2 class="
                                        text-center" id="cprice"></h2>
                                    <h5>
                                        <span style="text-decoration: line-through" class="text-secondary old-price"
                                            id="oldprice"></span>
                                    </h5>
                                </div>
                            </div>
                            {{-- <div class="clearfix product-price-cover">
                                <div class="product-price primary-color float-left">
                                    ...
                                    <span class="current-price text-brand" id="cprice"> </span>

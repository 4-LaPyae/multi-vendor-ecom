...
<div class="page-content"> 
 	...
 	<img src="{{ (!empty($vendorData->photo)) ? url('upload/vendor_images/'.$vendorData->photo):url('storage/nophoto.webp') }}" alt="Vendor" class="rounded-circle p-1 bg-primary" width="110">
					<div class="mt-3">
...
<div class="col-lg-8">
	...
	<option value="2026" {{ $vendorData->vendor_join == 2026  ? 'selected' : '' }}>2026</option>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					 <img id="showImage" src="{{ (!empty($vendorData->photo)) ? url('upload/vendor_images/'.$vendorData->photo):url('storage/nophoto.webp') }}" alt="Vendor" style="width:100px; height: 100px;"  >
				</div>
			</div>

								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex flex-column align-items-center text-center">
											<img src="{{ (!(is_null($adminData->photo))) ? asset('upload/admin_images/'.$adminData->photo):asset('storage/nophoto.webp') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="100" height="100">
					<div class="mt-3">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                 <img id="showImage" src="{{ (!empty($adminData->photo)) ? url('upload/admin_images/'.$adminData->photo):url('storage/nophoto.webp') }}" alt="Admin" style="width:100px; height: 100px;"  >
                                            </div>
                                        </div>
                                        <div class="row">

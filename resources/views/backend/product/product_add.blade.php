                            ...
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="short_descp" class="form-control @error('short_descp') is-invalid @enderror"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="long_descp">Hello, World!</textarea>
                                    </div>
                                    <div class="form-group mb-3">
                                        ...
                                        @error('product_thambnail')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <img src="" id="mainThmb" class="my-2" />
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="inputProductTitle" class="form-label">Multiple Image</label>
                                        <input
                                            class="form-control @error('multi_img')
                                            is-invalid
                                        @enderror"
                                            name="multi_img[]" type="file" id="multiImg" multiple="">
                                        @error('multi_img')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <div class="row py-2" id="preview_img"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="border border-3 p-4 rounded">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 ">
                                            ...
                                            <select name="vendor_id" class="form-select @error('vendor_id') is-invalid @enderror id="inputCollection">
                                                <option></option>
                                                @foreach ($activeusers as $vendor)

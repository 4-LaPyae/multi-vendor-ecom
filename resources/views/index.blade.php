...
<div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
    <div class="card">
        <div class="card-header">
            ...
            <br>
            <img id="showImage" src="{{ (!empty($userData->photo)) ? url('upload/user_images/'.$userData->photo):url('storage/nophoto.webp') }}" alt="User" class="rounded-circle p-1 bg-primary" width="100" height="100">
        </div>
        <div class="card-body">
            <p>
